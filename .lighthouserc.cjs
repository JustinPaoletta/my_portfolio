...
const createAssertions = (totalByteWeightBudget) => ({
  ...
  'total-byte-weight': ['warn', { maxNumericValue: totalByteWeightBudget }],
  ...
  'bf-cache': 'off',
  // Redirects: Static LHCI runs can produce null values for this audit
  redirects: 'off',
  ...
  // Third-party facades: Not actionable for this portfolio's static test environment
